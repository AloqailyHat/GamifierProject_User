...
The managaer app is built using node.js, it aims to let the manager customizes the user interface bases on the brand of the business and track the reward system for the It was implemented for coop-training Gamifier company.
